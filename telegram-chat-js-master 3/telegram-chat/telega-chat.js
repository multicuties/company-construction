...
<div class="chat__title">zprávy
<div class="btm__close chat__close">&times;</div>
</div>
<div class="chat__body">
<div class="chat__body__item chat__body__item__manager">
<span class="chat__body__item__user">Michal</span>
<span class="chat__body__item__text">Dobrý den Jaký je váš dotaz?</span>
<i class="chat__body__item__time">${timeNow}</i>
</div>
</div>
<div class="chat__input">
    <div class="chat__input__message">
        <textarea type="text" class="chat__main__input" aria-label="Napište nám zprávu" placeholder="" required></textarea>
    </div>
    <button class="chat__input__submit" aria-label="" style="background-image:url('img/angle-up.svg')">odeslat koopce</button>
</div>
...
init(){ 
  ...
  submit() {
    ...
    <span class="chat__body__item__user">Vy</span>
